...
/***/ (function(module, exports, __webpack_require__) {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      this.props.messages.map(function (message, i) {
	        return React.createElement(EchoMessage, { key: i, message: message });
	      })
	    );
	  }
	});
	...
	var EchoMessageComposer = React.createClass({
	  displayName: 'EchoMessageComposer',
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'div',
	          { className: 'send_message', onClick: this.onKeyPress },
	...
	var Echo = React.createClass({
	  ...
	  botresponse: function botresponse(message) {
	    setTimeout(function () {
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(EchoHistory, { messages: this.state.messages }),
	      React.createElement(EchoMessageComposer, { sendMessage: this.sendMessage })
	    );
	  }
	});

	ReactDOM.render(React.createElement(Echo, null), document.getElementById('app'));
